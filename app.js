        ...
        <div class="login-box">
              <div style="margin-bottom:20px">
                      <img src="${NEXUS_LOGO_DATA}" alt="Nexus Logo" style="width:100%; max-width:250px; height:auto; display:block; margin:0 auto">
                              <p style="font-size:11px; color:#888; font-weight:600; text-transform:uppercase; letter-spacing:1.5px; margin-top:8px; text-align:center">Chapecó - SC</p>
                                    </div>
                      ...
                      <img src="${NEXUS_LOGO_DATA}" alt="Nexus Logo" style="max-height:45px; margin-right:15px;">
                              <div>
                                        <strong style="font-size:18px">Portal do Professor</strong>
                                                  <div style="font-size:11px; color:rgba(255,255,255,0.75); font-weight:500; letter-spacing:1px; margin-top:2px;">Chapecó - SC</div>
                                                          </div>
                                                                </div>
